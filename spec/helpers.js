var mockInterface = function(){
  var htmlString = "<div id='testdiv'><div id='welcome_message'><h2>Press Space to begin and then start mashing!</h2></div><div id='countdown'></div><div id='canvas_container'></div><div id='drag_time'></div></div>";
